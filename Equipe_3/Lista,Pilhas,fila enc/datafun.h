...
{
    t_Fipe fipe;
    struct NoFipeSE *prox;
};

typedef struct NoFipeSE t_NoFipeSE;
typedef t_NoFipeSE* PNoFipeSE;
...
struct NoFipeDE
{
    t_Fipe fipe;
    struct NoFipeDE *ant;
    struct NoFipeDE *prox;
} NoFipeDE;

typedef struct NoFipeDE t_NoFipeDE;
typedef t_NoFipeDE* PNoFipeDE;
